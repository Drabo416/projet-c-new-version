...
CREATE TABLE `reserver` (
  ...
  `pla_id` int NOT NULL,
  PRIMARY KEY (`use_id`,`pla_id`),
  KEY `fk_reserver_relation__place` (`pla_id`),
  CONSTRAINT `fk_reserver_relation__place` FOREIGN KEY (`pla_id`) REFERENCES `place` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
